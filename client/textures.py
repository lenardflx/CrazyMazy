...
UI_IMAGES = {
    ...
    "SMOKE_2": _image_load("assets/images/ui/smoke-frame-2.png"),
    "SMOKE_3": _image_load("assets/images/ui/smoke-frame-3.png"),
    "SMOKE_4": _image_load("assets/images/ui/smoke-frame-4.png"),
    "SMOKE_5": _image_load("assets/images/ui/smoke-frame-5.png"),
    "SMOKE_6": _image_load("assets/images/ui/smoke-frame-6.png"),
    "SMOKE_7": _image_load("assets/images/ui/smoke-frame-7.png"),
    "FIRE_0": _image_load("assets/images/ui/fire-frame-0.png"),
    "FIRE_1": _image_load("assets/images/ui/fire-frame-1.png"),
    "FIRE_2": _image_load("assets/images/ui/fire-frame-2.png"),
    "FIRE_3": _image_load("assets/images/ui/fire-frame-3.png"),
    "FIRE_4": _image_load("assets/images/ui/fire-frame-4.png"),
    "FIRE_5": _image_load("assets/images/ui/fire-frame-5.png"),
    "FIRE_6": _image_load("assets/images/ui/fire-frame-6.png"),
    "FIRE_7": _image_load("assets/images/ui/fire-frame-7.png"),
    "TITLE_BACKGROUND_STATIC": _image_load("assets/images/ui/title-bg-nosmoke-static.png"),
    "TITLE_BACKGROUND_BLINK": _image_load("assets/images/ui/title-bg-nosmoke-blink.png"),
